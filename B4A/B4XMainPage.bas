...
Sub Class_Globals
	...
	Dim cam As Camera
	Private BtnActivateCam As Button
	Private BtnStopPreview As Button
	Private BtnStartPreview As Button
End Sub
...
Private Sub BtnActivateCam_Click
	cam.Initialize(Panel1, "InitializeCam")
End Sub
